...
export default function OurWork() {
  ...
  return (
    <section id="our-work" className="bg-[#f5f5f5] min-h-screen flex flex-col justify-center py-[140px]">
      <div className="max-w-[1440px] mx-auto px-[100px]">
        <AnimatedSection className="text-center max-w-[726px] mx-auto mb-20" duration={1} distance={80}>
          ...
          {projects.map((project, i) => (
            <AnimatedSection key={project.slug} delay={0.2 + 0.15 * i} className="shrink-0" scale>
              <Link href={`/projects/${project.slug}`} className="block">
                <div className="relative w-[510px] h-[640px] rounded-xl overflow-hidden group">
                  <Image
                  ...
                  <div className="absolute top-8 left-8">
                    <span className="backdrop-blur-[12px] bg-[#1f1f1f]/40 text-[#f5f5f5] text-[21px] leading-[1.2] px-4 py-2.5 rounded-lg">
                  ...
                  <div className="absolute bottom-8 left-8 right-8 flex flex-col gap-4">
                    <p className="text-[21px] text-[#f5f5f5] leading-[1.2]">
                      {project.title}
                    </p>
                    <div className="flex items-center gap-1 text-[#f5f5f5]">
                      <span className="text-base">Explore</span>
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="rotate-45">
